...
#this whole respository is a mess and needs refactoring
# this is going to be a submodule of accml.custom.tango
...
class DiffChannel(StandardReadable, Movable):
    ...
    async def set(self, diff_value) -> Status:
        assert self.reference_value is not None, NotInitalisedReferenceValue("Power converter diff value was not set")
