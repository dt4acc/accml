# -*- coding: utf-8 -*-
#
# accml documentation build configuration file, originally created for pySC: https://github.com/lmalina/pySC/blob/master/doc/conf.py
#
...
ABOUT_FILE = TOPLEVEL_DIR / "accml" / "__init__.py"
...
copyright_ = '2024, accml collaboration'
...
latex_documents = [
    (master_doc, 'accml.tex', u'accml Documentation',
     u'accml collaboration', 'manual'),
]
...
man_pages = [
    (master_doc, 'accml', u'accml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'accml', u'accml Documentation',
     author, 'accml', 'One line description of project.',
     'Miscellaneous'),
]
