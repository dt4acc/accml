...
async def main():
    ...
    backend = b2.bessyii_simulator_backend(data_dir / "03_reference_data" / "bessy2_storage_ring_reflat.json")
    ...
    with open(data_dir / "04_measurement_simulation_data" / "tune_response_data_from_simulator.json", "wt") as fp:
