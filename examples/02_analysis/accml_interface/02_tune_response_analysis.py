...
def main():
    ...
    if simulation:
        prep_data = data_from_simple_storage(
            "../../06_measurement_simulation_data/tune_response_data_from_simulator.json")
        save_file = "../../05_reference_data/tune_response_from_simulation.yml"
    elif ophyd_async_read:
        prep_data = data_from_simple_storage(
            "../../06_measurement_simulation_data/tune_response_data_with_ophyd_async.json")
